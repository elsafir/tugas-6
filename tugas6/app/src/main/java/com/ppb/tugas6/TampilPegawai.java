...
public class TampilPegawai extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tampilpegawai);
    ...
    private void showEmployee(String json){
        try {
            ...
            String desg = c.getString(konfigurasi.TAG_JABATAN);
            String sal = c.getString(konfigurasi.TAG_GAJI);
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params) {
                ...
                hashMap.put(konfigurasi.KEY_EMP_JABATAN,desg);
                hashMap.put(konfigurasi.KEY_EMP_GAJI,salary);
        ...
        alertDialogBuilder.setPositiveButton("Ya",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(TampilPegawai.this,TampilSemuaPegawai.class));
                    }
                });
